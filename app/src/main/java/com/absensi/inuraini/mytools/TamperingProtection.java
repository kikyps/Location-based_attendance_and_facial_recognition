package com.absensi.inuraini.mytools;
...
public class TamperingProtection {
     ...
     */
    @NonNull
    public static String[] getSignatures(@NonNull Context context) throws PackageManager.NameNotFoundException, NoSuchAlgorithmException, NoSuchAlgorithmException {
